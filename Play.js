...
export class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.expl_text = 'Goal: Perform as many operations as you can in the given time!\n\n\n\nThere will be 2 levels in total: BST and RB.\n\n\nIn BST level perform the given insert and delete tasks. You will be given 1 point for each succesfully performed operation.\n\n\n\nIn RB level perform insert operations and maintain red-black balance by performing red-black operations. You will be given 1 point when you insert a node and fix the tree sucessfully.\n\n\n\nIn this game mode it\'s important to be quick, therefore the operations are not animated anymore!';
        this.explanation_text = this.add.text(-680,-380, this.expl_text, { fontFamily: 'nasalization-rg', fontSize: '39px', fill: '#ffffff', align: 'justify', wordWrap: { width: 1400, useAdvancedWrap: true }});
