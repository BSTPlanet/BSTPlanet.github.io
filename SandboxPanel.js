export class SandboxPanel extends Phaser.Scene {
    ...
    create() {
        ...
        this.restart_text = this.add.text(1200,810, 'generate new tree and tasks', { fontFamily: 'nasalization-rg', fontSize: '21px', fill: '#ffffff', align: 'left', wordWrap: { width: 200, useAdvancedWrap: true } });
    }
