export class HelpBubble extends Phaser.Scene {
    ...
    create() {
        ...
        // this.closeText = this.add.text(505,215, 'to close', { fontFamily: 'audiowide', fontSize: '25px', fill: '#ffff00', align: 'center', wordWrap: { width: 760, useAdvancedWrap: true }});
        ...
        // this.explainButtons = this.add.text(470,500, 'ENTER\nARROWS\nESC\nBACKSPACE\nP\nSPACEBAR', { fontFamily: 'audiowide', fontSize: '30px', fill: '#ffffff', align: 'justify', wordWrap: { width: 760, useAdvancedWrap: true }});
    ...
    setHelp(string) {
        switch (string) {
            case 'title':
                ...
                this.keyboardText = this.add.text(-450,-500, 'The KEYBOARD will be your tool.\nUse the ARROW KEYS, ENTER, ESC and H key to navigate the menu.', { fontFamily: 'audiowide', fontSize: '28px', fill: '#ffffff', align: 'center', wordWrap: { width: 1500, useAdvancedWrap: true }});
                ...
                this.explanation = this.add.text(-580,-210, text, { fontFamily: 'audiowide', fontSize: '25px', fill: '#ffffff', align: 'justify', wordWrap: { width: 900, useAdvancedWrap: true }});
            ...
            case 'learn':
                ...
                this.explanation = this.add.text(-580,-190, text, { fontFamily: 'audiowide', fontSize: '25px', fill: '#ffffff', align: 'justify', wordWrap: { width: 900, useAdvancedWrap: true }});
            ...
            case 'sandbox':
                ...
                var text = 'Here you can practice what you learned!\n\n\nIn both levels you will be given a random tree and random tasks for you to perform.\n\n\nYou can generate a new tree and new tasks by pressing the N key.\n\n\nThe operations are animated so you can see what happens when you perform an operation.';
                this.explanation = this.add.text(-580,-170, text, { fontFamily: 'audiowide', fontSize: '25px', fill: '#ffffff', align: 'justify', wordWrap: { width: 900, useAdvancedWrap: true }});
            ...
            case 'play':
                ...
                this.gamePaused_text = this.add.text(-630,-200,'GAME PAUSED', { fontFamily: 'audiowide', fontSize: '70px', fill: '#ff3665'});

                // init container stuff
                this.keyboardImg = this.add.image(424,-460, 'keyboard').setScale(0.8);
                this.keyboardText = this.add.text(200,-370, 'Q and E to zoom out/in.\n\nHold W, A, S, D keys to move camera.\n\nARROW KEYS to walk through the tree.\n\nENTER to insert node.\n\nBACKSPACE to delete node.\n\nM to select min node for deletion.\n\nL to rotate left.\n\nR to rotate right.\n\nF to flip colors.\n\nSPACEBAR to go to the next level.\n\nESC to go back to menu.', { fontFamily: 'audiowide', fontSize: '19px', fill: '#ffffff', align: 'justify'});
            ...
            case 'keyboard_BST':
                ...
                this.keyboardText = this.add.text(190,-310, 'Q and E to zoom out/in.\n\nHold W, A, S, D keys to move camera.\n\nARROW KEYS to walk through the tree.\n\nENTER to insert node.\n\nBACKSPACE to delete node.\n\nM to select min node for deletion.\n\nSPACEBAR to go to the next level.\n\nESC to go back to menu.', { fontFamily: 'audiowide', fontSize: '21px', fill: '#ffffff', align: 'justify'});
            ...
            default:
                this.explanation = this.add.text(200,400, 'NO HELP BUBBLE INITIALIZED and H KEY WILL GIVE AN ERROR', { fontFamily: 'audiowide', fontSize: '40px', fill: '#ffffff', align: 'justify', wordWrap: { width: 1300, useAdvancedWrap: true }}).setDepth(10);
                break;
        }
    }
