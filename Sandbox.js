...
export class Sandbox extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('background_green', 'Assets/background_planet_green_singleLarge.png');
    ...
    create() {
        ...
        this.add.image(10_000,750,'background_green').setDepth(-1);

        // Text on top of the game world
        var text1 = this.add.text(9_000,100, 'Sandbox', { fontSize: '30px', fill: '#000' });
        //Instructions
