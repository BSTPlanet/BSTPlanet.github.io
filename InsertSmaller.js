...
const node_63 = {x:1100, y:813, name: "node_63"}

export class InsertSmaller extends Phaser.Scene {

    constructor() {
        super({ key:'InsertSmaller' });
    }
    ...
    create() {
       ...
       // *************** TASKS + TASK ACTIONS ***************
        ...
        function taskSucceededActions(scene) {
            ...
            if (tasks[0] == 63 && !(singleTon.nodeSetRB.has(node_63))) {
                console.log(singleTon.nodeSetRB)
                singleTon.addNodeRB(node_63)
            }
                ...
                this.time.addEvent({
                    ...
                    callback: function(scene) {
                        if (tasks[0] == data.task[0]) {  // if it's the first task then talk about that
                            expert.talk('insertSmaller',3);
                        } else {                         // if it's the last task then talk about the last thing and give reward node
                            expert.talk('insertSmaller',5);
                            panel.rewardNodeActions(63);
                        }
    ...
    // *************** CHECK ROTATE RIGHT + ROTATE RIGHT ***************
