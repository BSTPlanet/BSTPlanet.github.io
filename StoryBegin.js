var storyText = 'The alien Alf was on a mission in the far far edge of the galaxy when its ship exploded. Alf was stranded on a distant rocky planet of the binary search trees (BST). The pieces of the ship got scattered around the planet. In order to collect them, Alf needs to navigate through the planet, but it’s tricky! The only way to navigate is to solve the binary search trees! The lost alien contacts his friend Exero through a hologram phone. He is a planet expert and has knowledge about the BST planets. With Exero’s help, Alf tries to navigate through the planet to collect his scattered tools and pieces of the ship!';
