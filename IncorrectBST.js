...
export class IncorrectBST extends Phaser.Scene {

    constructor() {
        super({ key:'IncorrectBST' });
    }
    ...
    create() {
        ...
        var text1 = this.add.text(2000,100, 'Incorrect BST', { fontSize: '30px', fill: '#000' });
        //Instructions
        ...
        keyR.on('down', () => {
            destroyEverything();
            this.scene.restart('IncorrectBST');
        ...
        var numsToInsert = [33,1,55,53,17,70,14,50,16,48,5,60,80]; //wrong order for incorrect presentation
        
        //numsToInsert.sort(() => Math.random() - 0.5)
        //numsToInsert.shuffle();
        ...
        // BST (randomly inserted)
        tree.createRoot(this);
        // numsToInsert.forEach(key => {
        //     insertAutomatic(tree.root, key, this);
        // });
